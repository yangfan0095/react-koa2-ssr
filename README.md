...
##### 目前我自己的服务器出了问题，API接口暂时无法请求， 有需要的可以换成你们自己的接口来试🤔 有问题欢迎提issue 问题能用issue 解决 千万不要加我QQ😂


###### 针对大家问的比较多的问题
* 比如ssr node端与后端在不同的域名下如何共享数据，权限校验。 这个问题你的api接口和你的node端服务 需要配置在同一个基础域名下，才能共享cookie。（有其他问题欢迎issue）
* 关于项目重构的问题，目前正在计划中，但是由于平时工作比较忙，欢迎PR.
